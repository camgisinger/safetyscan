        ...
        <main style={{ flex: 1, maxWidth: 600, width: '100%', margin: '0 auto', padding: '0 18px 48px', boxSizing: 'border-box', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ height: 280, borderRadius: 6, background: 'var(--surf)', border: '1.5px solid var(--line)', display: 'grid', placeItems: 'center', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'relative', width: 180, height: 180 }}>
              ...
              <div style={{ position: 'absolute', top: -6, right: -28, padding: '5px 10px', borderRadius: 4, background: '#D63A26', color: '#fff', fontSize: 11, fontWeight: 600, transform: 'rotate(8deg)', boxShadow: '0 6px 16px -6px rgba(0,0,0,0.4)' }}>Missing sign</div>
              <div style={{ position: 'absolute', bottom: 8, left: -30, padding: '5px 10px', borderRadius: 4, background: 'var(--amber)', color: '#1B1A12', fontSize: 11, fontWeight: 600, transform: 'rotate(-6deg)', boxShadow: '0 6px 16px -6px rgba(0,0,0,0.4)' }}>Cone gap 8m</div>
            </div>
          </div>
