  ...
  if (notFound) return (
    <div style={{ minHeight: '100vh', background: OFFWHITE, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "Inter, system-ui, sans-serif" }}>
      <div style={{ textAlign: 'center', padding: 40 }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 700, color: NAVY, marginBottom: 8 }}>Scan not available</div>
        <div style={{ fontSize: 14, color: '#7A7468', marginBottom: 24 }}>This scan link is no longer active or has been disabled.</div>
        <a href="/" style={{ padding: '12px 24px', background: AMBER, color: NAVY, borderRadius: 8, fontSize: 14, fontWeight: 600, textDecoration: 'none' }}>Try SafetyScan</a>
      </div>
    </div>
  )
    ...
    <div style={{ minHeight: '100vh', background: OFFWHITE, fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <main style={{ maxWidth: 600, margin: '0 auto', padding: '24px 16px 48px' }}>
        ...
        <div style={{ fontSize: 11, color: '#aaa', lineHeight: 1.6, textAlign: 'center', padding: '0 10px', marginBottom: 28 }}>
          This report was generated by SafetyScan AI. Results are indicative only.
        </div>

        {/* CTA */}
        <div style={{ background: NAVY, borderRadius: 16, padding: '24px 20px', textAlign: 'center' }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: '#fff', marginBottom: 6 }}>Want to run your own compliance checks?</div>
